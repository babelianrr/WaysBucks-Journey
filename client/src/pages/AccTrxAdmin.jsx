...
export default function AccTrxAdmin() {
        ...
        <Row>
          <Col xs="7">
            ...
            <form onSubmit={handleSubmit}>
              <input className="form-control" type="hidden" name="status" value="Delivering" onChange={handleChange} id="formGroupStatus" required />
